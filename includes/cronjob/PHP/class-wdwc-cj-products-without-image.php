<?php
/**
 * WDWC Cronjob Delete Products without Image
 *
 * 
 *
 * @link 
...
class WDWC_CJ_Products_Without_Image {
    ...
    private static function wdwc_cj_head( $bot_cat ) {
        $name = "Woocommerce Delete Products without image";
    ...
    private static function wdwc_cj_main_task( $hash, $bot ) {
        ...
        foreach( $products as $p ):
            ...
            WDWC_Helper::wdwc_delete_product( $p, 'no-image', $hash, $bot );
            $count_delete++;
